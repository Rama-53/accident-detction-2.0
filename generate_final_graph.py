...
# Using less height for plots to leave room for the large text blocks below
fig, axes = plt.subplots(2, 2, figsize=(A4_WIDTH, A4_HEIGHT * 0.65)) 
...
# Create a massive GLOBAL LEGEND at the bottom
fig.legend(lines, labels, loc='lower center', bbox_to_anchor=(0.5, 0.25), ncol=3, fontsize=10, frameon=True)

# Equations Text Box (Left Side)
equations_text = (
...
plt.figtext(0.1, 0.05, equations_text,
            ha="left", va="bottom", fontsize=10, fontweight='bold',
            bbox={"facecolor":"white", "alpha":0.0, "pad":0, "edgecolor":"none" })

# Legend Terminology Text Box (Right Side)
terminology_text = (
    "Legend Terminology:\n"
...
plt.figtext(0.55, 0.10, terminology_text,
            ha="left", va="bottom", fontsize=9,
            bbox={"facecolor":"#eaf2f8", "alpha":0.8, "pad":10, "boxstyle":"round,pad=1"})

# Subplots adjustment
plt.subplots_adjust(wspace=0.35, hspace=0.3)
# Allocate bottom 35% of the A4 page for legends and text
plt.tight_layout(rect=[0.02, 0.35, 0.98, 0.94]) 

plt.savefig('performance_threshold_a4_final.png', dpi=300, bbox_inches='tight')
print("Final graph with equations saved to performance_threshold_a4_final.png")
